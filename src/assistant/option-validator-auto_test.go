...
var _ = Describe("OptionValidator", func() {
	...
	DescribeTable("ParamSet with validation",
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedDuration(
					...
					func(value time.Duration, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Setup: func() {
				paramSet.Native.Gradientf32 = float32(32.0)
			},
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedFloat32(
					...
					func(value float32, _ *pflag.Flag) error {
						Expect(value).To(Equal(float32(32.0)))
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedFloat64(
					...
					func(value float64, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedInt(
					...
					func(value int, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedInt16(
					...
					func(value int16, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedInt32(
					...
					func(value int32, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedInt64(
					...
					func(value int64, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedInt8(
					...
					func(value int8, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedIPMask(
					...
					func(value net.IPMask, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedIPNet(
					...
					func(value net.IPNet, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedUint16(
					...
					func(value uint16, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedUint32(
					...
					func(value uint32, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedUint64(
					...
					func(value uint64, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedUint8(
					...
					func(value uint8, _ *pflag.Flag) error {
		...
		Entry(nil, OvEntry{
			...
			Validator: func() assistant.OptionValidator {
				...
				return paramSet.BindValidatedUint(
					...
					func(value uint, _ *pflag.Flag) error {
